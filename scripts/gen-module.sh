...
type $upper_name"ScreenProps" = $upper_name"RouteProps" & $upper_name"StateProps";
...
export default React.memo($upper_name_screen);" >> "$SOURCEDIR/views/$upper_name_screen.tsx"
# src
mkdir "$SOURCEDIR/src/"
